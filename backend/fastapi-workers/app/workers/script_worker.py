    ...
    def _mock_script(self, keyword, category_label, target_minutes):
        ...
        sections_dict = {
            "인트로": [
                ...
                "지금 이 시점에 진입해도 괜찮을지, 아니면 비중을 줄여야 할지 고민이 많으실 겁니다.",
                "결론부터 말씀드리면, 단기 변동성에 흔들리지 않는 신중한 대응이 필요한 시점입니다.",
                "오늘 영상에서 객관적인 데이터와 구체적인 대응 시나리오를 바탕으로 명확하게 정리해 드리겠습니다.",
                "끝까지 보시면 향후 어떤 포지션을 취해야 하는지 명확한 가이드를 얻으실 수 있을 것입니다.",
                "그럼 바로 시작해 보겠습니다."
            ],
            "시장 배경": [
                f"먼저 {category_label} 시장의 최근 전체적인 흐름부터 짚어보겠습니다.",
                "최근 며칠간 글로벌 거시경제 환경이 매우 빠르게 변화하고 있는데요.",
                "미국의 통화 정책 기조 변화와 더불어 국채 금리 움직임이 시장에 직접적인 영향을 주고 있습니다.",
                "특히 최근 외국인과 기관 투자자의 순매수 동향을 보면 매우 흥미로운 변화가 감지되고 있습니다.",
                "양대 주체의 매매 포지션이 엇갈리면서 지수의 방향성을 쉽게 예측하기 힘든 상황이 전개되고 있는데요.",
                "글로벌 주요 증시 또한 이와 연동되어 변동성을 함께 키워가는 모습입니다.",
                "이러한 전반적인 배경 흐름을 정확히 짚고 넘어가야 세부 데이터 분석이 의미를 가집니다."
            ],
            "핵심 데이터": [
                f"그렇다면 {keyword} 관련해서 우리가 주목해야 할 구체적인 핵심 데이터를 살펴보겠습니다.",
                "우선 시장 거래량 추이입니다. 최근 거래량이 20일 평균 대비 의미 있게 증가하는 모습을 보여주고 있습니다.",
                "이는 시장 참여자들의 관심도가 다시금 뜨겁게 달아오르고 있다는 신호이기도 합니다.",
                "동시에 기술적 지표들을 보면, 현재 지수는 주요 60일 이동평균선 부근에서 강한 지지력을 시험하고 있습니다.",
                "단기 저항선은 매물대가 촘촘하게 쌓여 있는 직전 고점 부근이 될 것으로 예상되는데요.",
                "RSI나 MACD 같은 보조 지표들을 종합해 보면 과매도 국면은 벗어났으나 단기 숨고르기 가능성이 열려 있습니다.",
                "기업들의 실적 전망치와 밸류에이션 부담 지표도 업종 평균치 내에서 움직이고 있습니다."
            ],
            "시나리오 분석": [
                "이와 같은 대내외 데이터를 바탕으로 앞으로 그려볼 수 있는 시나리오는 두 가지입니다.",
                "첫 번째는 상승 시나리오입니다. 지지선을 딛고 거래량이 실리며 단기 저항선을 돌파하는 흐름인데요.",
                "이 경우 원달러 환율의 안정화와 글로벌 증시의 우상향이 뒷받침되어야 할 것입니다.",
                "두 번째는 하락 및 횡보 시나리오입니다. 추가적인 악재나 수급 이탈로 지지선이 붕괴되는 경우인데요.",
                "이때는 전저점 부근까지 밀릴 수 있으므로 분할 매수 관점에서도 보수적인 접근이 필요합니다.",
                "현재 시점에서 각 시나리오의 실현 가능성을 저울질해 본다면 횡보 및 완만한 상승 확률을 조금 더 높게 보고 있습니다.",
                "어느 방향이든 시장의 실시간 움직임에 유연하게 대응할 수 있는 포트폴리오를 구성해 두어야 합니다."
            ],
            "실행 가이드": [
                "이러한 상황에서 우리 개인 투자자분들이 취해야 할 구체적인 실행 가이드를 정리해 드립니다.",
                "첫째, 한 번에 모든 자금을 투입하기보다는 분할 매수 전략으로 리스크를 분산하시기 바랍니다.",
                "둘째, 최악의 시나리오를 대비해 감내할 수 있는 명확한 손절 기준선을 설정해 두는 것이 좋습니다.",
                "셋째, 특정 종목이나 테마에만 자산이 쏠려 있지 않은지 포트폴리오 다변화 상태를 꼭 재점검하세요.",
                "넷째, 시장 급변동기에 흔히 발생하는 군중 심리에 의한 뇌동매매를 가장 경계해야 합니다.",
                "다섯째, 돌아오는 주간의 주요 경제 지표 발표 일정과 연준 위원들의 연설 등 변동성 이벤트를 체크하세요."
            ],
            "결론": [
                "오늘 다룬 {keyword} 분석 내용을 요약해 드립니다.",
                "첫째, 시장은 현재 중요한 지지선과 저항선 사이에서 방향을 모색하는 수렴 구간에 있습니다.",
                "둘째, 거래량 변화와 메이저 수급 주체들의 동향이 단기 방향성의 트리거가 될 것입니다.",
                "셋째, 무리한 추격 매수보다는 철저히 분할 대응과 철저한 리스크 관리가 우선시되는 시장입니다.",
                "참고로 본 분석 내용은 객관적 데이터에 기반한 정보 제공일 뿐, 특정 방향으로의 투자를 권유하는 것이 아닙니다.",
                "모든 투자의 최종 결정과 책임은 투자자 본인에게 있음을 다시 한번 강조 드립니다.",
                "오늘 내용이 도움되셨다면 구독과 좋아요 부탁드리고, 다음 영상에서 더 유익한 정보로 찾아뵙겠습니다. 감사합니다."
            ]
        }

        sections = []
        for name in SECTION_NAMES:
            sentences = sections_dict.get(name, [])
            section_text = " ".join(sentences)
            
            if len(section_text) < chars_per_section:
                extra_sentences = [
                    f"이 부분은 {keyword} 관련해서 특히 주목해야 할 포인트입니다.",
                    "투자자 입장에서 이 데이터가 왜 중요한지 조금 더 보완해서 설명드리겠습니다.",
                    "실제 과거 사례를 보면 이런 유형의 패턴이 반복적으로 나타나곤 했습니다.",
                    "전문가들의 의견도 이 부분에 대해서는 대체로 신중해야 한다는 데 의견이 일치합니다.",
                    "과거 유사한 거시경제 지표 발표 이후 시장이 어떻게 반응했는지 복기해 볼 필요가 있습니다.",
                    "이러한 흐름이 지속될 경우 향후 수 주간 시장 전반에 걸쳐 상당한 변화가 예상되기도 합니다.",
                    "다만 변수가 워낙 많은 구간이므로 개인 투자자 입장에서는 자산 배분에 신경을 써야 합니다.",
                    "여기서 우리가 놓치면 안 되는 핵심적인 고려 요소가 하나 더 존재합니다.",
                    "따라서 시장의 실시간 호재와 악재의 상대적인 강도를 면밀히 모니터링해야 합니다.",
                    "수급의 주체들이 장중에 어떤 형태로 포지션을 전환하는지도 중요한 관전 포인트입니다."
                ]
                idx = 0
                while len(section_text) < chars_per_section:
                    section_text += " " + extra_sentences[idx % len(extra_sentences)]
                    idx += 1
