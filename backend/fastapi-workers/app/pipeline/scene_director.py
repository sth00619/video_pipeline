...
Goldie is an anthropomorphic GOLD COIN mascot: one round coin disc remains the dominant unified head-and-upper-body silhouette,
with an embossed dot rim, expressive cartoon eyes, white-gloved hands, two short compact arms, and two short compact legs. A scene-specific costume may wrap modestly below the coin rim,
but it must not become a narrow-necked independent human trunk, and each visible leg stays roughly half the coin diameter or shorter. Do not copy any existing channel mascot.
